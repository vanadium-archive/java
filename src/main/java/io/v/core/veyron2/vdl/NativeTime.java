...
public class NativeTime {
    ...
    static final class DurationConverter extends Converter {
        ...
        private DurationConverter() {
            super(io.v.core.veyron2.vdl.vdlroot.src.time.Duration.class);
        }
        ...
        public VdlValue vdlValueFromNative(Object nativeValue) {
            ...
            return new io.v.core.veyron2.vdl.vdlroot.src.time.Duration(millis / MILLIS_PER_SECOND,
                    (int) ((millis % MILLIS_PER_SECOND) * NANOS_PER_MILLISECOND));
        }

        @Override
        public Object nativeFromVdlValue(VdlValue value) {
            assertInstanceOf(value, io.v.core.veyron2.vdl.vdlroot.src.time.Duration.class);
            final io.v.core.veyron2.vdl.vdlroot.src.time.Duration wireDuration =
                    (io.v.core.veyron2.vdl.vdlroot.src.time.Duration) value;
    ...
    static final class DateTimeConverter extends Converter {
        ...
        private DateTimeConverter() {
            super(io.v.core.veyron2.vdl.vdlroot.src.time.Time.class);
        }
        ...
        public VdlValue vdlValueFromNative(Object nativeValue) {
            ...
            return new io.v.core.veyron2.vdl.vdlroot.src.time.Time(millis / MILLIS_PER_SECOND,
                    (int) ((millis % MILLIS_PER_SECOND) * NANOS_PER_MILLISECOND));
        }

        @Override
        public Object nativeFromVdlValue(VdlValue value) {
            assertInstanceOf(value, io.v.core.veyron2.vdl.vdlroot.src.time.Time.class);
            final io.v.core.veyron2.vdl.vdlroot.src.time.Time wireTime =
                    (io.v.core.veyron2.vdl.vdlroot.src.time.Time) value;
