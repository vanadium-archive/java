...
public final class ErrorThrowerFactory {
    public static ErrorThrower bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static ErrorThrower bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.examples.wspr_sample.gen_impl.ErrorThrowerStub(client, name);
    }
}
