...
public final class ViewerServiceWrapper {
    ...
    private final io.veyron.examples.pipetobrowser.ViewerService service;




    public ViewerServiceWrapper(final io.veyron.examples.pipetobrowser.ViewerService service) {
