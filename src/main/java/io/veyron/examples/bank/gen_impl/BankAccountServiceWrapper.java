...
public final class BankAccountServiceWrapper {
    ...
    private final io.veyron.examples.bank.BankAccountService service;




    public BankAccountServiceWrapper(final io.veyron.examples.bank.BankAccountService service) {
