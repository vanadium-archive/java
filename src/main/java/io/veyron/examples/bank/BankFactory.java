...
/* Factory for binding to Bank interfaces. */
public final class BankFactory {
    public static Bank bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Bank bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.examples.bank.gen_impl.BankStub(client, name);
    }
}
