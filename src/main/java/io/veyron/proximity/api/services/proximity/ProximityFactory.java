...
/* Factory for binding to Proximity interfaces. */
public final class ProximityFactory {
    public static Proximity bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Proximity bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.proximity.api.services.proximity.gen_impl.ProximityStub(client, name);
    }
}
