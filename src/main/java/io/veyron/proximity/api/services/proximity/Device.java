 ...
 **/
public final class Device implements android.os.Parcelable, java.io.Serializable {
    ...
    public Device(final java.lang.String mAC, final java.util.List<java.lang.String> names, final java.lang.String distance) {
    ...
    public void writeToParcel(android.os.Parcel out, int flags) {
    		...
    		com.veyron2.vdl.ParcelUtil.writeValue(out, mAC);
    	
    		com.veyron2.vdl.ParcelUtil.writeValue(out, names);
    	
    		com.veyron2.vdl.ParcelUtil.writeValue(out, distance);
    	
    }
	public static final android.os.Parcelable.Creator<Device> CREATOR
		= new android.os.Parcelable.Creator<Device>() {
		@Override
	...
	private Device(android.os.Parcel in) {
		
			this.mAC = (java.lang.String) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.mAC);
		
			this.names = (java.util.List<java.lang.String>) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.names);
		
			this.distance = (java.lang.String) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.distance);
