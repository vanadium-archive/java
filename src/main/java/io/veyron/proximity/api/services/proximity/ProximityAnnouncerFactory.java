...
/* Factory for binding to ProximityAnnouncer interfaces. */
public final class ProximityAnnouncerFactory {
    public static ProximityAnnouncer bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static ProximityAnnouncer bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.proximity.api.services.proximity.gen_impl.ProximityAnnouncerStub(client, name);
    }
}
