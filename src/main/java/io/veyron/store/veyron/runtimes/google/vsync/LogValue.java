...
public final class LogValue implements android.os.Parcelable, java.io.Serializable {
    static final long serialVersionUID = 0L;
      ...
      @com.google.gson.annotations.SerializedName("Mutation")
      private io.veyron.store.veyron.services.store.raw.Mutation mutation;
    
      @com.google.gson.annotations.SerializedName("SyncTime")
    ...
    public LogValue(final io.veyron.store.veyron.services.store.raw.Mutation mutation, final long syncTime, final boolean delete, final boolean continued) {
    ...
    public io.veyron.store.veyron.services.store.raw.Mutation getMutation() {
        return this.mutation;
    }
    public void setMutation(io.veyron.store.veyron.services.store.raw.Mutation mutation) {
        this.mutation = mutation;
    }
	...
	private LogValue(android.os.Parcel in) {
			...
			this.mutation = (io.veyron.store.veyron.services.store.raw.Mutation) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.mutation);
