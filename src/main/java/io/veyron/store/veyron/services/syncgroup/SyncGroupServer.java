...
public interface SyncGroupServer extends com.veyron2.services.security.access.Object {
...
// against the object's ACL.
    ...
    public io.veyron.store.veyron.services.syncgroup.SyncGroupInfo create(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.SyncGroupConfig createArgs, final io.veyron.store.veyron2.storage.ID rootOID, final io.veyron.store.veyron.services.syncgroup.NameIdentity joiner, final io.veyron.store.veyron.services.syncgroup.JoinerMetaData metaData) throws com.veyron2.ipc.VeyronException;
    public io.veyron.store.veyron.services.syncgroup.SyncGroupInfo create(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.SyncGroupConfig createArgs, final io.veyron.store.veyron2.storage.ID rootOID, final io.veyron.store.veyron.services.syncgroup.NameIdentity joiner, final io.veyron.store.veyron.services.syncgroup.JoinerMetaData metaData, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
...
// TODO(m3b): The label should be read and write; can that be expressed?
    ...
    public io.veyron.store.veyron.services.syncgroup.SyncGroupInfo join(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.NameIdentity joiner, final io.veyron.store.veyron.services.syncgroup.JoinerMetaData metaData) throws com.veyron2.ipc.VeyronException;
    public io.veyron.store.veyron.services.syncgroup.SyncGroupInfo join(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.NameIdentity joiner, final io.veyron.store.veyron.services.syncgroup.JoinerMetaData metaData, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
...
// have permission to Join() the SyncGroup.)
    ...
    public void leave(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.NameIdentity name) throws com.veyron2.ipc.VeyronException;
    public void leave(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.NameIdentity name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
...
// the caller must have admin permission on the SyncGroup.
    ...
    public void eject(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.NameIdentity name) throws com.veyron2.ipc.VeyronException;
    public void eject(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.NameIdentity name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
...
// the caller must have admin permission on the SyncGroup.
    ...
    public void destroy(final com.veyron2.ipc.Context context, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
...
// TODO(m3b): This call may be removed when Watch is implemented.
    ...
    public io.veyron.store.veyron.services.syncgroup.SyncGroupInfo get(final com.veyron2.ipc.Context context) throws com.veyron2.ipc.VeyronException;
    public io.veyron.store.veyron.services.syncgroup.SyncGroupInfo get(final com.veyron2.ipc.Context context, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
...
// the caller must have admin permission on the SyncGroup.
    ...
    public void setConfig(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.SyncGroupConfig config, final java.lang.String eTag) throws com.veyron2.ipc.VeyronException;
    public void setConfig(final com.veyron2.ipc.Context context, final io.veyron.store.veyron.services.syncgroup.SyncGroupConfig config, final java.lang.String eTag, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
