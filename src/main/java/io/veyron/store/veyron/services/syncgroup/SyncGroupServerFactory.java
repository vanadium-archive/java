...
/* Factory for binding to SyncGroupServer interfaces. */
public final class SyncGroupServerFactory {
    public static SyncGroupServer bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static SyncGroupServer bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.store.veyron.services.syncgroup.gen_impl.SyncGroupServerStub(client, name);
    }
}
