...
/* Factory for binding to storeThing interfaces. */
public final class storeThingFactory {
    public static storeThing bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static storeThing bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.store.veyron.services.store.server.gen_impl.storeThingStub(client, name);
    }
}
