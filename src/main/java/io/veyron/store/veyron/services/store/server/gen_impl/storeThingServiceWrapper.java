...
public final class storeThingServiceWrapper {

    private final io.veyron.store.veyron.services.store.server.storeThingService service;
    ...
    private final io.veyron.store.veyron2.services.store.gen_impl.TransactionServiceWrapper transactionWrapper;
    

    public storeThingServiceWrapper(final io.veyron.store.veyron.services.store.server.storeThingService service) {
        ...
        this.transactionWrapper = new io.veyron.store.veyron2.services.store.gen_impl.TransactionServiceWrapper(service);
