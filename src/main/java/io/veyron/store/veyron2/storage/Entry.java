...
public final class Entry implements android.os.Parcelable, java.io.Serializable {
    static final long serialVersionUID = 0L;
      ...
      private io.veyron.store.veyron2.storage.Stat stat;
    ...
    public Entry(final io.veyron.store.veyron2.storage.Stat stat, final com.veyron2.vdl.Any value) {
    ...
    public io.veyron.store.veyron2.storage.Stat getStat() {
        return this.stat;
    }
    public void setStat(io.veyron.store.veyron2.storage.Stat stat) {
        this.stat = stat;
    }
	...
	private Entry(android.os.Parcel in) {
			...
			this.stat = (io.veyron.store.veyron2.storage.Stat) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.stat);
