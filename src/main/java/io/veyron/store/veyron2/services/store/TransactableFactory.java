...
/* Factory for binding to Transactable interfaces. */
public final class TransactableFactory {
    public static Transactable bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Transactable bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.store.veyron2.services.store.gen_impl.TransactableStub(client, name);
    }
}
