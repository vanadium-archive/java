...
/* Factory for binding to ObjectSpecific interfaces. */
public final class ObjectSpecificFactory {
    public static ObjectSpecific bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static ObjectSpecific bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.store.veyron2.services.store.gen_impl.ObjectSpecificStub(client, name);
    }
}
