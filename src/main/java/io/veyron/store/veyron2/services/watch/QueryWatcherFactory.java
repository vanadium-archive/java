...
/* Factory for binding to QueryWatcher interfaces. */
public final class QueryWatcherFactory {
    public static QueryWatcher bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static QueryWatcher bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new io.veyron.store.veyron2.services.watch.gen_impl.QueryWatcherStub(client, name);
    }
}
