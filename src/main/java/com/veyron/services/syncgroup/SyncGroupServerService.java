...
@com.veyron2.vdl.VeyronService(serviceWrapper=com.veyron.services.syncgroup.gen_impl.SyncGroupServerServiceWrapper.class)
...
// against the object's ACL.
    ...
    public com.veyron.services.syncgroup.SyncGroupInfo create(final com.veyron2.ipc.ServerContext context, final com.veyron.services.syncgroup.SyncGroupConfig createArgs, final com.veyron2.storage.ID rootOID, final com.veyron.services.syncgroup.NameIdentity joiner, final com.veyron.services.syncgroup.JoinerMetaData metaData) throws com.veyron2.ipc.VeyronException;
...
// TODO(m3b): The label should be read and write; can that be expressed?
    ...
    public com.veyron.services.syncgroup.SyncGroupInfo join(final com.veyron2.ipc.ServerContext context, final com.veyron.services.syncgroup.NameIdentity joiner, final com.veyron.services.syncgroup.JoinerMetaData metaData) throws com.veyron2.ipc.VeyronException;
...
// have permission to Join() the SyncGroup.)
    ...
    public void leave(final com.veyron2.ipc.ServerContext context, final com.veyron.services.syncgroup.NameIdentity name) throws com.veyron2.ipc.VeyronException;
...
// the caller must have admin permission on the SyncGroup.
    ...
    public void eject(final com.veyron2.ipc.ServerContext context, final com.veyron.services.syncgroup.NameIdentity name) throws com.veyron2.ipc.VeyronException;
...
// TODO(m3b): This call may be removed when Watch is implemented.
    ...
    public com.veyron.services.syncgroup.SyncGroupInfo get(final com.veyron2.ipc.ServerContext context) throws com.veyron2.ipc.VeyronException;
...
// the caller must have admin permission on the SyncGroup.
    ...
    public void setConfig(final com.veyron2.ipc.ServerContext context, final com.veyron.services.syncgroup.SyncGroupConfig config, final java.lang.String eTag) throws com.veyron2.ipc.VeyronException;
