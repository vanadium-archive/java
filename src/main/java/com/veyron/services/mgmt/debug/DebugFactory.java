...
/* Factory for binding to Debug interfaces. */
public final class DebugFactory {
    public static Debug bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Debug bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.services.mgmt.debug.gen_impl.DebugStub(client, name);
    }
}
