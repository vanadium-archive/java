...
/* Factory for binding to Root interfaces. */
public final class RootFactory {
    public static Root bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Root bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.services.mgmt.root.gen_impl.RootStub(client, name);
    }
}
