...
public final class ConfigFactory {
    public static Config bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Config bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.services.mgmt.node.gen_impl.ConfigStub(client, name);
    }
}
