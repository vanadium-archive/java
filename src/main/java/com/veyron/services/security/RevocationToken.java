 ...
 **/
public final class RevocationToken implements java.util.List<java.lang.Byte>, android.os.Parcelable, java.io.Serializable {
    ...
    public static final android.os.Parcelable.Creator<RevocationToken> CREATOR = new android.os.Parcelable.Creator<RevocationToken>() {
        @Override
        public RevocationToken createFromParcel(android.os.Parcel in) {
            return new RevocationToken(in);
        }
        @Override
        public RevocationToken[] newArray(int size) {
            return new RevocationToken[size];
        }
    };
    private RevocationToken(android.os.Parcel in) {
