...
/* Factory for binding to Clock interfaces. */
public final class ClockFactory {
    public static Clock bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Clock bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.lib.testutil.modules.gen_impl.ClockStub(client, name);
    }
}
