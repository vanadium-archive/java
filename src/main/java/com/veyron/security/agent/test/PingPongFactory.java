...
/* Factory for binding to PingPong interfaces. */
public final class PingPongFactory {
    public static PingPong bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static PingPong bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.security.agent.test.gen_impl.PingPongStub(client, name);
    }
}
