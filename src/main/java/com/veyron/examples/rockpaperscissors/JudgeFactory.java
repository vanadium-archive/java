...
public final class JudgeFactory {
    public static Judge bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Judge bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.examples.rockpaperscissors.gen_impl.JudgeStub(client, name);
    }
}
