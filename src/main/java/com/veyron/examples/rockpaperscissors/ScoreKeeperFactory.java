...
/* Factory for binding to ScoreKeeper interfaces. */
public final class ScoreKeeperFactory {
    public static ScoreKeeper bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static ScoreKeeper bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.examples.rockpaperscissors.gen_impl.ScoreKeeperStub(client, name);
    }
}
