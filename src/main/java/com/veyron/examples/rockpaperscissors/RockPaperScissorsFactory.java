...
/* Factory for binding to RockPaperScissors interfaces. */
public final class RockPaperScissorsFactory {
    public static RockPaperScissors bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static RockPaperScissors bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.examples.rockpaperscissors.gen_impl.RockPaperScissorsStub(client, name);
    }
}
