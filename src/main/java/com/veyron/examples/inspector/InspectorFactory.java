...
public final class InspectorFactory {
    public static Inspector bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Inspector bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron.examples.inspector.gen_impl.InspectorStub(client, name);
    }
}
