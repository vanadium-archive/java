...
/**
 * type Stat struct{Kind veyron.io/store/veyron2/storage.Kind int16;ID veyron.io/store/veyron2/storage.ID [16]byte;MTimeNS int64;Attrs []any} 
...
public final class Stat implements android.os.Parcelable, java.io.Serializable {
    static final long serialVersionUID = 0L;
      ...
      private com.veyron.io.store.veyron2.storage.Kind kind;
    
      @com.google.gson.annotations.SerializedName("ID")
      private com.veyron.io.store.veyron2.storage.ID iD;
    
      @com.google.gson.annotations.SerializedName("MTimeNS")
      private long mTimeNS;
    
      @com.google.gson.annotations.SerializedName("Attrs")
      private java.util.List<com.veyron2.vdl.Any> attrs;
    

    
    public Stat(final com.veyron.io.store.veyron2.storage.Kind kind, final com.veyron.io.store.veyron2.storage.ID iD, final long mTimeNS, final java.util.List<com.veyron2.vdl.Any> attrs) {
    ...
    public com.veyron.io.store.veyron2.storage.Kind getKind() {
        return this.kind;
    }
    public void setKind(com.veyron.io.store.veyron2.storage.Kind kind) {
        this.kind = kind;
    }
    
    public com.veyron.io.store.veyron2.storage.ID getID() {
        return this.iD;
    }
    public void setID(com.veyron.io.store.veyron2.storage.ID iD) {
        this.iD = iD;
    }
	...
	private Stat(android.os.Parcel in) {
			...
			this.kind = (com.veyron.io.store.veyron2.storage.Kind) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.kind);
		
			this.iD = (com.veyron.io.store.veyron2.storage.ID) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), this.iD);
