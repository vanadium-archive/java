...
/* Factory for binding to LogFile interfaces. */
public final class LogFileFactory {
    public static LogFile bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static LogFile bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.services.mgmt.logreader.gen_impl.LogFileStub(client, name);
    }
}
