...
/* Factory for binding to Stats interfaces. */
public final class StatsFactory {
    public static Stats bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Stats bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.services.mgmt.stats.gen_impl.StatsStub(client, name);
    }
}
