...
public final class BuildFactory {
    public static Build bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Build bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.services.mgmt.build.gen_impl.BuildStub(client, name);
    }
}
