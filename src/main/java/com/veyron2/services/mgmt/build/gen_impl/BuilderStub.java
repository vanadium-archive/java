...
public final class BuilderStub implements com.veyron2.services.mgmt.build.Builder {
    private static final java.lang.String vdlIfacePathOpt = "veyron2/services/mgmt/build/Builder";
    ...
    public com.veyron2.vdl.ClientStream<com.veyron2.services.mgmt.build.File,com.veyron2.services.mgmt.build.File, byte[]> build(final com.veyron2.ipc.Context context, final com.veyron2.services.mgmt.build.Architecture Arch, final com.veyron2.services.mgmt.build.OperatingSystem OS, com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.vdl.ClientStream<com.veyron2.services.mgmt.build.File, com.veyron2.services.mgmt.build.File, byte[]>() {
            @Override
            ...
            @Override
            public byte[] finish() throws com.veyron2.ipc.VeyronException {
