...
// build the sources and streams back the compiled binaries.
    ...
    public java.util.List<java.lang.Byte> build(final com.veyron2.ipc.ServerContext context, final com.veyron2.services.mgmt.build.Architecture Arch, final com.veyron2.services.mgmt.build.OperatingSystem OS, com.veyron2.vdl.Stream<com.veyron2.services.mgmt.build.File, com.veyron2.services.mgmt.build.File> stream) throws com.veyron2.ipc.VeyronException;
