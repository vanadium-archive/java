...
/* Factory for binding to Application interfaces. */
public final class ApplicationFactory {
    public static Application bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Application bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.services.mgmt.repository.gen_impl.ApplicationStub(client, name);
    }
}
