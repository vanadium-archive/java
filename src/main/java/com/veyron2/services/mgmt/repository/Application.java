...
// matching profile, respecting the order of the input argument.
    ...
    public com.veyron2.services.mgmt.application.Envelope match(final com.veyron2.ipc.Context context, final java.util.List<java.lang.String> Profiles, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException;
