...
/* Factory for binding to Profile interfaces. */
public final class ProfileFactory {
    public static Profile bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Profile bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.services.mgmt.repository.gen_impl.ProfileStub(client, name);
    }
}
