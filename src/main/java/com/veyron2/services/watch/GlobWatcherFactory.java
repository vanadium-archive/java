...
/* Factory for binding to GlobWatcher interfaces. */
public final class GlobWatcherFactory {
    public static GlobWatcher bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static GlobWatcher bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.services.watch.gen_impl.GlobWatcherStub(client, name);
    }
}
