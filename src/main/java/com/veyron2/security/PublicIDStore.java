 ...
 * required to be blessing the same public key and must be tagged with a PrincipalPattern.
...
public interface PublicIDStore {
	 ...
	 * @param  peerPattern     PrincipalPattern of the peer the PublicID should be associated with.
	 * @throws VeyronException if the PublicID couldn't be added to the store.
	 */
	public void add(PublicID id, PrincipalPattern peerPattern) throws VeyronException;
	...
	/**
	 * Returns a PublicID from the store based on the default PrincipalPattern.  The returned
	 ...
	 *
	 * @return                 PublicID matching the default PrincipalPattern.
	 * @throws VeyronException if no PublicID matches the default PrincipalPattern.
	 */
	public PublicID defaultPublicID() throws VeyronException;

	/**
	 * Sets the default PrincipalPattern.  In the absence of any calls to this method, the default
	 * PrincipalPattern is assumed to be "*", which matches all PublicIDs.
	 *
	 * @param  pattern         the new default PrincipalPattern.
