...
/* Factory for binding to ServiceB interfaces. */
public final class ServiceBFactory {
    public static ServiceB bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static ServiceB bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.vdl.test_base.gen_impl.ServiceBStub(client, name);
    }
}
