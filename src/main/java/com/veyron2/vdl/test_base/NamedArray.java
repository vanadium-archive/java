 ...
 **/
public final class NamedArray implements java.util.List<java.lang.Boolean>, android.os.Parcelable, java.io.Serializable {
    ...
    public static final android.os.Parcelable.Creator<NamedArray> CREATOR = new android.os.Parcelable.Creator<NamedArray>() {
        @Override
        public NamedArray createFromParcel(android.os.Parcel in) {
            return new NamedArray(in);
        }
        @Override
        public NamedArray[] newArray(int size) {
            return new NamedArray[size];
        }
    };
    private NamedArray(android.os.Parcel in) {
        impl = (com.veyron2.vdl.FixedLengthList<java.lang.Boolean>) com.veyron2.vdl.ParcelUtil.readValue(in, getClass().getClassLoader(), impl);
    }
}
