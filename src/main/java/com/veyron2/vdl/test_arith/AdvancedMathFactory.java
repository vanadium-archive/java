...
/* Factory for binding to AdvancedMath interfaces. */
public final class AdvancedMathFactory {
    public static AdvancedMath bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static AdvancedMath bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.vdl.test_arith.gen_impl.AdvancedMathStub(client, name);
    }
}
