...
import com.veyron.lib.testutil.modules.gen_impl.ClockStub;
...
public class ClockFactory {
	public static Clock bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Clock bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
