...
public final class EchoStub implements Echo {
	...
	public EchoStub(com.veyron2.ipc.Client client, java.lang.String name) {
		this.client = client;
		this.name = name;
	}
	// Methods from interface Echo.
	@Override
	public java.lang.String echo(com.veyron2.ipc.Context context, java.lang.String msg) throws com.veyron2.ipc.VeyronException {
		return echo(context, msg, null);
	}
	@Override
	public java.lang.String echo(com.veyron2.ipc.Context context, java.lang.String msg, com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
