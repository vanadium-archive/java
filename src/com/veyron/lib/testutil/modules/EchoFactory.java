...
import com.veyron.lib.testutil.modules.gen_impl.EchoStub;
...
public class EchoFactory {
	public static Echo bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Echo bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
