...
public class Server { 
	/* Server stub creation methods for interfaces in file: test_base.vdl. */
	public static Object newTypeTester(TypeTesterService service) { 
		return new TypeTesterStub(service);
	}
	
	/* Server stubs for interfaces in file: test_base.vdl. */
	public static class TypeTesterStub {
		private final TypeTesterService service;

		TypeTesterStub(TypeTesterService service) {
