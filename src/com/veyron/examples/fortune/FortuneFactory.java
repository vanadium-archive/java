...
import com.veyron.examples.fortune.gen_impl.FortuneStub;
...
public class FortuneFactory {
	public static Fortune bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Fortune bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
