...
import com.veyron.examples.pipetobrowser.gen_impl.ViewerStub;
...
public class ViewerFactory {
	public static Viewer bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Viewer bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
