...
import com.veyron.examples.bank.gen_impl.BankStub;
...
public class BankFactory {
	public static Bank bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Bank bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
