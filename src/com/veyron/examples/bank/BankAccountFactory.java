...
import com.veyron.examples.bank.gen_impl.BankAccountStub;
...
public class BankAccountFactory {
	public static BankAccount bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static BankAccount bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
