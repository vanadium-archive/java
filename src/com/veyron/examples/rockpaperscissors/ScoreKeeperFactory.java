...
import com.veyron.examples.rockpaperscissors.gen_impl.ScoreKeeperStub;
...
public class ScoreKeeperFactory {
	public static ScoreKeeper bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static ScoreKeeper bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
