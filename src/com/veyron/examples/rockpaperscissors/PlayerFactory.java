...
import com.veyron.examples.rockpaperscissors.gen_impl.PlayerStub;
...
public class PlayerFactory {
	public static Player bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Player bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
