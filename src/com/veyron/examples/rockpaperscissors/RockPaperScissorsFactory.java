...
import com.veyron.examples.rockpaperscissors.gen_impl.RockPaperScissorsStub;
...
public class RockPaperScissorsFactory {
	public static RockPaperScissors bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static RockPaperScissors bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new RockPaperScissorsStub(client, name);
	}
}
