...
import com.veyron.services.mgmt.root.gen_impl.RootStub;
...
public class RootFactory {
	public static Root bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Root bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
