...
import com.veyron.services.store.raw.gen_impl.StoreStub;
...
public class StoreFactory {
	public static Store bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Store bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
