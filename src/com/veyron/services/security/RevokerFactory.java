...
import com.veyron.services.security.gen_impl.RevokerStub;
...
public class RevokerFactory {
	public static Revoker bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Revoker bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new RevokerStub(client, name);
	}
}
