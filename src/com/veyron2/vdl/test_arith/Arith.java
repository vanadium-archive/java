...
public interface Arith { 
	...
	public int add(Context context, int a, int b, Client.CallOption... opts) throws VeyronException;
...
// just like Go.
	public Arith.DivModOut divMod(Context context, int a, int b, Client.CallOption... opts) throws VeyronException;
	// Sub shows that you can use data types defined in other packages.
	public int sub(Context context, Args args, Client.CallOption... opts) throws VeyronException;
	// Mul tries another data type defined in another package.
	public int mul(Context context, NestedArgs nested, Client.CallOption... opts) throws VeyronException;
...
// values, and regular const expressions may also be used.
	public void genError(Context context, Client.CallOption... opts) throws VeyronException;
	// Count shows using only an int32 out-stream type, with no in-stream type.
	public ClientStream<Void,Integer,Void> count(Context context, int start, Client.CallOption... opts) throws VeyronException;
	// StreamingAdd shows a bidirectional stream.
	public ClientStream<Integer,Integer,Integer> streamingAdd(Context context, Client.CallOption... opts) throws VeyronException;
	// QuoteAny shows the any built-in type, representing a value of any type.
	public Object quoteAny(Context context, Object a, Client.CallOption... opts) throws VeyronException;
}
