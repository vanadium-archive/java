...
import com.veyron2.vdl.test_arith.gen_impl.AdvancedMathStub;

/* Factory for binding to AdvancedMath interfaces. */
public class AdvancedMathFactory {
	public static AdvancedMath bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static AdvancedMath bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new AdvancedMathStub(client, name);
	}
}
