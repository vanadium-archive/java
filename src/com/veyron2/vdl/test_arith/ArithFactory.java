...
import com.veyron2.vdl.test_arith.gen_impl.ArithStub;
...
public class ArithFactory {
	public static Arith bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Arith bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
