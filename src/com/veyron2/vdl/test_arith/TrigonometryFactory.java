...
import com.veyron2.vdl.test_arith.gen_impl.TrigonometryStub;

/* Factory for binding to Trigonometry interfaces. */
public class TrigonometryFactory {
	public static Trigonometry bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Trigonometry bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
