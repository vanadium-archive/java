...
/* Factory for binding to Trigonometry interfaces. */
public final class TrigonometryFactory {
    public static Trigonometry bind(final java.lang.String name) throws com.veyron2.ipc.VeyronException {
        return bind(name, null);
    }
    public static Trigonometry bind(final java.lang.String name, final com.veyron2.Options veyronOpts) throws com.veyron2.ipc.VeyronException {
        ...
        return new com.veyron2.vdl.test_arith.gen_impl.TrigonometryStub(client, name);
    }
}
