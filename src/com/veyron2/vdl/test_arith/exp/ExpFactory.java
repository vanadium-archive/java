...
import com.veyron2.vdl.test_arith.exp.gen_impl.ExpStub;

/* Factory for binding to Exp interfaces. */
public class ExpFactory {
	public static Exp bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Exp bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
