...
import com.veyron2.vdl.test_base.gen_impl.ServiceBStub;

/* Factory for binding to ServiceB interfaces. */
public class ServiceBFactory {
	public static ServiceB bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static ServiceB bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new ServiceBStub(client, name);
	}
}
