...
import com.veyron2.vdl.test_base.gen_impl.ServiceAStub;

/* Factory for binding to ServiceA interfaces. */
public class ServiceAFactory {
	public static ServiceA bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static ServiceA bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
