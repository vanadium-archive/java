...
import com.veyron2.services.mgmt.repository.gen_impl.ProfileStub;

/* Factory for binding to Profile interfaces. */
public class ProfileFactory {
	public static Profile bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Profile bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
