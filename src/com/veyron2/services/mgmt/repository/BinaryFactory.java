...
import com.veyron2.services.mgmt.repository.gen_impl.BinaryStub;
import com.veyron2.vdl.ClientStream;
import java.util.ArrayList;

/* Factory for binding to Binary interfaces. */
public class BinaryFactory {
	public static Binary bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Binary bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new BinaryStub(client, name);
	}
}
