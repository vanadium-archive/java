...
import com.veyron2.services.mgmt.repository.gen_impl.ApplicationStub;
import java.util.ArrayList;

/* Factory for binding to Application interfaces. */
public class ApplicationFactory {
	public static Application bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Application bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
