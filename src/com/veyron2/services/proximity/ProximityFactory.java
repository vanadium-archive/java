...
import com.veyron2.services.proximity.gen_impl.ProximityStub;
import java.util.ArrayList;

/* Factory for binding to Proximity interfaces. */
public class ProximityFactory {
	public static Proximity bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static Proximity bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new ProximityStub(client, name);
	}
}
