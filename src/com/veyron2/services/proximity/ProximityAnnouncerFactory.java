...
import com.veyron2.services.proximity.gen_impl.ProximityAnnouncerStub;

/* Factory for binding to ProximityAnnouncer interfaces. */
public class ProximityAnnouncerFactory {
	public static ProximityAnnouncer bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static ProximityAnnouncer bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
