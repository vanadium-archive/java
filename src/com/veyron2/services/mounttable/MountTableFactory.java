...
import com.veyron2.services.mounttable.gen_impl.MountTableStub;
import com.veyron2.vdl.ClientStream;
import java.util.ArrayList;

/* Factory for binding to MountTable interfaces. */
public class MountTableFactory {
	public static MountTable bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static MountTable bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
		...
		return new MountTableStub(client, name);
	}
}
