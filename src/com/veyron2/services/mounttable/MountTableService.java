...
import com.veyron2.services.mounttable.gen_impl.MountTableServiceWrapper;
...
// act as if it was never present as far as the interface is concerned.
	public void mount(ServerContext context, String server, int tTL) throws VeyronException;
...
// Returns a non-nil error iff Server remains mounted at the mount point.
	public void unmount(ServerContext context, String server) throws VeyronException;
...
// servers to query and the suffix at those servers.
	public MountTableService.ResolveStepOut resolveStep(ServerContext context) throws VeyronException;
}
