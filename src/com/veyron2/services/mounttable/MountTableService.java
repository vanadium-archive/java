...
// act as if it was never present as far as the interface is concerned.
    ...
    public void mount(final com.veyron2.ipc.ServerContext context, final java.lang.String Server, final int TTL) throws com.veyron2.ipc.VeyronException;
...
// Returns a non-nil error iff Server remains mounted at the mount point.
    ...
    public void unmount(final com.veyron2.ipc.ServerContext context, final java.lang.String Server) throws com.veyron2.ipc.VeyronException;

    
    // ResolveStep takes the next step in resolving a name.  Returns the next
// servers to query and the suffix at those servers.

    public com.veyron2.services.mounttable.MountTable.ResolveStepOut resolveStep(final com.veyron2.ipc.ServerContext context) throws com.veyron2.ipc.VeyronException;
