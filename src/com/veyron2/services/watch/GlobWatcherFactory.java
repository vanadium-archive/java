...
import com.veyron2.services.watch.gen_impl.GlobWatcherStub;
import com.veyron2.vdl.ClientStream;

/* Factory for binding to GlobWatcher interfaces. */
public class GlobWatcherFactory {
	public static GlobWatcher bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static GlobWatcher bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
