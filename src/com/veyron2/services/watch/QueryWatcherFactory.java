...
import com.veyron2.services.watch.gen_impl.QueryWatcherStub;
import com.veyron2.vdl.ClientStream;

/* Factory for binding to QueryWatcher interfaces. */
public class QueryWatcherFactory {
	public static QueryWatcher bind(String name) throws VeyronException {
		return bind(name, null);
	}
	public static QueryWatcher bind(String name, Options veyronOpts) throws VeyronException {
		Client client = null;
