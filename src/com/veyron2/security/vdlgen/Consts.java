...
// Source(s): types.vdl
package com.veyron2.security.vdlgen;
...
public static final int READ_LABEL = 1;
	// WriteLabel allows write operations.
public static final int WRITE_LABEL = 2;
	// AdminLabel allows administrative operations.
public static final int ADMIN_LABEL = 4;
	// DebugLabel allows debug operations.
public static final int DEBUG_LABEL = 8;
	// MonitoringLabel allows monitoring operations.
public static final int MONITORING_LABEL = 16;
}
