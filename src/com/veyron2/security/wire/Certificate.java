...
/**
 * type Certificate struct{Name string;PublicKey veyron2/security/wire.PublicKey struct{Curve veyron2/security/wire.KeyCurve byte;XY []byte};Caveats []veyron2/security/wire.Caveat struct{Service veyron2/security.PrincipalPattern string;Bytes []byte};Signature veyron2/security.Signature struct{R []byte;S []byte}} 
...
public final class Certificate {
      ...
      private java.util.ArrayList<com.veyron2.security.wire.Caveat> caveats;
    
      private com.veyron2.security.Signature signature;
    

    
    public Certificate(final java.lang.String name, final com.veyron2.security.wire.PublicKey publicKey, final java.util.ArrayList<com.veyron2.security.wire.Caveat> caveats, final com.veyron2.security.Signature signature) {
    ...
    public java.util.ArrayList<com.veyron2.security.wire.Caveat> getCaveats() {
        return this.caveats;
    }
    public void setCaveats(java.util.ArrayList<com.veyron2.security.wire.Caveat> caveats) {
        this.caveats = caveats;
    }
