 ...
 * This preference is stored as a Boolean preference named `{@value #REMOTE_INSPECTION_PREF}`. If
 * this setting is already set upon instantiation, remote inspection is immediately enabled.
 */
public class RemoteInspection {
    ...
    private final VAndroidContextTrait<?> mVAndroidContext;
    private final SharedPreferences mSharedPreferences;

    private VContext mVContext;
    private RemoteInspectors mRemoteInspectors;

    public RemoteInspection(final VAndroidContextTrait<?> context,
