...
public class BlessingService {
     ...
     *
     * @deprecated Use {@link io.v.android.libs.security.BlessingsManager} instead, which has
     *             a more convenient API (though it doesn't yet support fetching blessings from
     *             an AccountManager).
     *
